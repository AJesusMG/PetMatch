    ...
    const handleLogout = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // Puedes cambiar "/login" con la ruta deseada
    ...
    return (
        <Card className={styles.card} key={props.id}>
            ...
            <CardActions className={styles.myAccountCard__actions} sx={{ height: "70%", padding: "15px 3px" }}>
                <Link to="/MyAccount" className={styles.myAccountCard__link}>
                ...
                <Button variant="text" className={styles.myAccountCard__button} onClick={handleLogout}>
